#############################################################################
# Makefile for building: testGraphicusGUI
# Generated by qmake (3.1) (Qt 6.4.2)
# Project:  testGraphicusGUI.pro
# Template: app
# Command: /usr/bin/qmake6 -o Makefile testGraphicusGUI.pro
#############################################################################
...
CFLAGS        = -pipe -g -fPIC -D_REENTRANT -Wall -Wextra $(DEFINES)
CXXFLAGS      = -pipe -g -fPIC -D_REENTRANT -Wall -Wextra $(DEFINES)
INCPATH       = -I. -IGraphicusGUI -I/usr/include/qt6 -I/usr/include/qt6/QtWidgets -I/usr/include/qt6/QtGui -I/usr/include/qt6/QtCore -I. -I/usr/lib/qt6/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = testGraphicusGUI1.0.0
DISTDIR = /home/master/Dropbox/A/scholar/sherbrooke/s2/app3/code/TestGraphicusGUI/.tmp/testGraphicusGUI1.0.0
LINK          = g++
LFLAGS        = -Wl,-rpath,/usr/lib -Wl,-rpath-link,/usr/lib
LIBS          = $(SUBLIBS) GraphicusGUI/graphicusGUI.lib /usr/lib/libQt6Widgets.so /usr/lib/libQt6Gui.so /usr/lib/libGLX.so /usr/lib/libOpenGL.so /usr/lib/libQt6Core.so -lpthread -lGLX -lOpenGL   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = testGraphicusGUI.cpp \
		monInterface.cpp 
OBJECTS       = testGraphicusGUI.o \
		monInterface.o
DIST          = /usr/lib/qt6/mkspecs/features/spec_pre.prf \
		...
		testGraphicusGUI.pro monInterface.h testGraphicusGUI.cpp \
		monInterface.cpp
QMAKE_TARGET  = testGraphicusGUI
DESTDIR       = 
...
testGraphicusGUI:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: testGraphicusGUI.pro /usr/lib/qt6/mkspecs/linux-g++/qmake.conf /usr/lib/qt6/mkspecs/features/spec_pre.prf \
		/usr/lib/qt6/mkspecs/common/unix.conf \
		/usr/lib/qt6/mkspecs/common/linux.conf \
		/usr/lib/qt6/mkspecs/common/sanitize.conf \
		/usr/lib/qt6/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents monInterface.h $(DISTDIR)/
	$(COPY_FILE) --parents testGraphicusGUI.cpp monInterface.cpp $(DISTDIR)/
...
moc_predefs.h: /usr/lib/qt6/mkspecs/features/data/dummy.cpp
	g++ -pipe -g -fPIC -dM -E -o moc_predefs.h /usr/lib/qt6/mkspecs/features/data/dummy.cpp
...
testGraphicusGUI.o: testGraphicusGUI.cpp monInterface.h \
		GraphicusGUI/graphicusGUI.h \
		GraphicusGUI/centralWidget.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o testGraphicusGUI.o testGraphicusGUI.cpp

monInterface.o: monInterface.cpp monInterface.h \
		GraphicusGUI/graphicusGUI.h \
		GraphicusGUI/centralWidget.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o monInterface.o monInterface.cpp
